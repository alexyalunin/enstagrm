...
const Enstagrm = EnstagrmContract.at('0x02b2048876325bc461fc5e7c695287013f759a08');
...
$("#registerButton").click(function() {
    $("#loader").show();
    Enstagrm.register($("#nicknameInput").val(), {from: web3.eth.defaultAccount, gas:3000000}, (err, res) => {
        if (err) {
            console.log(err);
        } else {
            console.log(res);
